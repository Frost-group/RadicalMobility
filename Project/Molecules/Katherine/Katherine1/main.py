...
if __name__ == "__main__":
    input_mol_file = "Katherine1.mol"  # Changed to .xyz
    
    radical_monomer_charge = -1
    radical_monomer_multiplicity = 3
    anion_monomer_charge = -2
    anion_monomer_multiplicity = 2
    cation_monomer_charge = 0
    cation_monomer_multiplicity = 2
    radical_dimer_charge = -2
    radical_dimer_multiplicity = 5
    stack_distance = 8
