...
def calculate_reorganization_energy(neutral_xyz_file, anion_xyz_file, cation_xyz_file):
    ...
    E_anion_optimized = calculate_single_molecule_energy(anion_xyz_file, -1, 1, "anion_energy.log")
    E_neutral_in_anion_geom = calculate_single_molecule_energy(anion_xyz_file, 0, 2, "neutral_in_anion_energy.log")
    E_anion_in_neutral_geom = calculate_single_molecule_energy(neutral_xyz_file, -1, 1, "anion_in_neutral_energy.log")
...
if __name__ == "__main__":
    neutral_xyz_file = "opt_radical_Katherine3.mol"
    anion_xyz_file = "opt_anion_Katherine3.mol"
    cation_xyz_file = "opt_cation_Katherine3.mol"
