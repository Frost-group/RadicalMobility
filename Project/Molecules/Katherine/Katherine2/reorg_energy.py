...
def calculate_reorganization_energy(neutral_xyz_file, anion_xyz_file, cation_xyz_file):
    ...
    E_neutral_optimized = calculate_single_molecule_energy(neutral_xyz_file, -2, 2, "neutral_energy.log")
    E_anion_optimized = calculate_single_molecule_energy(anion_xyz_file, -3, 1, "anion_energy.log")
    E_neutral_in_anion_geom = calculate_single_molecule_energy(anion_xyz_file, -2, 2, "neutral_in_anion_energy.log")
    E_anion_in_neutral_geom = calculate_single_molecule_energy(neutral_xyz_file, -3, 1, "anion_in_neutral_energy.log")
    ...
    E_cation_optimized = calculate_single_molecule_energy(cation_xyz_file, -1, 1, "cation_energy.log")
    E_neutral_in_cation_geom = calculate_single_molecule_energy(cation_xyz_file, -2, 2, "neutral_in_cation_energy.log")
    E_cation_in_neutral_geom = calculate_single_molecule_energy(neutral_xyz_file, -1, 1, "cation_in_neutral_energy.log")
...
if __name__ == "__main__":
    neutral_xyz_file = "opt_radical_Katherine2.mol"
    anion_xyz_file = "opt_anion_Katherine2.mol"
    cation_xyz_file = "opt_cation_Katherine2.mol"
